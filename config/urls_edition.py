...
urlpatterns = [
    ...
    path("mot-de-passe/", editing.password, name="password"),
    ...
    path("section/<int:pk>/liste/<str:name>/ajouter", editing.item_add, name="item-add"),
    path("section/<int:pk>/liste/<str:name>/<int:index>/", editing.item, name="item"),
